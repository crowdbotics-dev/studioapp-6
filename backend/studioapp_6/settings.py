"""
Django settings for studioapp_6 project.
...
WSGI_APPLICATION = 'studioapp_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "studioapp_6 API",
    "DESCRIPTION": "API documentation for studioapp_6 App",
    "VERSION": "v1",
}
